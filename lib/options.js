...
exports.readCmdOptions = function() {
	...
	var options = {
		...
		metrics_file: "/root/cloudwatch2graphite/config/metrics.json",
		credentials_file: "/root/cloudwatch2graphite/config/credentials.json"
	};
	...
	if (creds.accessKeyId == undefined || creds.accessKeyId.indexOf("REPLACE") == 0 || creds.secretAccessKey == undefined || creds.secretAccessKey.indexOf("REPLACE") == 0) {
		console.error("Error : aws credential file is missing or invalid : ./config/credentials.json");
		process.exit(1);
	}
